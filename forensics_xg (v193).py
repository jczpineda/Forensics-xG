...
#         ])
# 
#         # UNIVERSAL FIX: Opta data natively attacks 100 for all teams. No artificial coordinate flipping here.
#         def get_xt(x, y):
...
#                         # Grab teams dynamically from the events, assuming first event usually features the Home team
#                         teams = match_df['Team'].unique()
# 
#                         # We don't rely on Home/Away. The selected squad ALWAYS attacks x=100.
#                         c1, c2, c3 = st.columns(3)
...
# 
#                         # UNIVERSAL NORMALIZATION: Selected Team data is natively x=100. No flips needed!
...
# 
#                         # UNIVERSAL NORMALIZATION: Opponent is strictly flipped so their attacks visually map against your defense at x=0
...
#                             pitch.draw(ax=ax)
# 
#                             # Strict Single-Assist Lookahead logic to prevent double-dipping on goals
...
#                                     if not prior.empty:
#                                         # Only grab the absolute most recent set-piece before this specific goal
...
#                                         if not prior.empty:
#                                             # Only grab the absolute most recent penetration before this specific goal
