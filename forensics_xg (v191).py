...
#     with tabs[i]:
#         sub_t1, sub_t2, sub_t3 = st.tabs(["📊 STATISTICAL REPORTS", "⚽ MATCH TELEMETRY", "👤 PLAYER PROFILE"])
# 
#         # === TAB A: STATS ===
#         with sub_t1:
...
#                             st.subheader("🎬 Actions Leading to Shots")
#                             st.info("Traces the creation vector (Pass Origin → Exact Shot Location) for each attempt. Filtered for direct involvement.")
# 
...
#                             st.subheader("⚡ Counter Attacks & Rapid Transitions")
...
# 
#                         st.markdown(f"### 👤 {sel_player_p.upper()} | ISOLATED REPORT")
#                         st.divider()
# 
...
# 
#                         # --- OFFENSIVE METRICS ---
#                         st.markdown("#### ⚔️ OFFENSIVE INVOLVEMENT")
...
# 
#                         mc1.metric("👟 Passes", f"{succ_p_passes}/{total_p_passes}", f"{p_acc}% Acc")
#                         mc2.metric("🎯 Shots", p_shots)
#                         mc3.metric("🏃‍♂️ Prog. Carries (>10m)", prog_carries)
#                         mc4.metric("✨ Succ. Dribbles", dribbles_won)
# 
#                         st.divider()
# 
#                         # --- DEFENSIVE INTEGRITY METRICS ---
#                         st.markdown("#### 🛡️ DEFENSIVE INTEGRITY")
...
# 
#                         dc1.metric("✅ Tackles & Interceptions", tackles_won + interceptions, f"{interceptions} Interceptions")
#                         dc2.metric("❌ Challenges Lost", tackles_lost, "Dribbled Past")
#                         dc3.metric("⚠️ Fouls Committed", fouls_committed)
# 
#                         # Color code the True Tackle Rate (Red if under 50%)
#                         if true_tackle_rate >= 50:
#                             dc4.metric("⚖️ True Tackle Win Rate", f"{true_tackle_rate}%", f"{tackles_won}/{total_engagements} Engagements")
#                         else:
#                             dc4.metric("⚖️ True Tackle Win Rate", f"{true_tackle_rate}%", f"-{total_engagements - tackles_won} Failed Engagements")
