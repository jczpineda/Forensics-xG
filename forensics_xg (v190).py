...
# 
# # --- 5. INTERFACE ---
# # NOTE: The 'header {visibility: hidden;}' line has been completely removed to restore the 3 dots.
# st.markdown("""
#     <style>
...
#                         st.divider()
# 
#                         vis_options = ["Actions Leading to Shots", "Counter Attacks (Rapid Transitions)", "Set Piece Targeting (Corners)", "The Architect (Build-Up Phase)", "Defensive Shield (Heatmap + Line)", "Momentum Map", "Duel Map (Tackles Won/Lost)", "Game Control (Possession)", "Zone 14 & Half-Spaces", "Creator Map (Shot Assists)", "Passing Network (Structure)", "Pass Sonar (Radar)", "Impact Zone (Convex Hull)", "Attacking Zones (5 Lanes)", "Zone Invasions", "The Pulse (Shot Race)", "The Breakout (Progressive Carries)", "The Air Raid (Crossing Zones)", "Pass Map", "Passing Heatmap", "Defensive Actions", "General Heatmap"]
...
#                                     else:
#                                         ax.add_patch(mpatches.Rectangle((draw_x, 0), 100-draw_x, 100, alpha=0.1, color='#ffd700', ec=None))
# 
